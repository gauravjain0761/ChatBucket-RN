        ...
        <View style={AppStyles.purpleMainContainer}>
            ...
            <View style={AppStyles.bottomWhiteView}>
                <SafeAreaView>
                    ...
                    <ButtonPurple extraStyle={{ marginBottom: type == 'email' ? hp(6) : hp(0) }} onPress={() => navigation.navigate(type == 'mobile' ? SCREENS.MissCallScreen : SCREENS.OTPScreen)} title={'Verify'} />
                </SafeAreaView>
            </View>
        </View>
    )
