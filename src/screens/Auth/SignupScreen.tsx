        ...
        <SafeAreaView>
          <View style={styles.rowView}>
            ...
            >
              <Text
                style={[
                  type == "mobile" ? styles.selectedTaBText : styles.tabText,
                ]}
              >
                Mobile
              </Text>
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      type == "mobile" ? colors.mainPurple : "transparent",
                  },
                ]}
              />
            </TouchableOpacity>
            ...
            >
              <Text
                style={[
                  type == "email" ? styles.selectedTaBText : styles.tabText,
                ]}
              >
                Email
              </Text>
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      type == "email" ? colors.mainPurple : "transparent",
                  },
                ]}
              />
            </TouchableOpacity>
            ...
            <View>
              ...
              >
                <CountryPicker
                  ...
                  withEmoji={false}
                  onSelect={(country) => {
                    setcountry(country), setisModalVisible(false);
                  }}
                />
                <Text
                  style={{
          ...
          <ButtonPurple
            extraStyle={{ marginBottom: type == "email" ? hp(6) : hp(0) }}
            onPress={() => onSignup()}
            title={"Verify"}
          />
        </SafeAreaView>
